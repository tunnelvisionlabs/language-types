        ...
        public async Task TestTypesProvided()
        {
            await new VerifyCS.Test
            {
                TestState =
                {
                    ...
                    Sources =
                    {
                        @"namespace System.Diagnostics.CodeAnalysis { class AllowNullAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class DisallowNullAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class MaybeNullAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class NotNullAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class MaybeNullWhenAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class NotNullWhenAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class NotNullIfNotNullAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class DoesNotReturnAttribute { } }",
                        @"namespace System.Diagnostics.CodeAnalysis { class DoesNotReturnIfAttribute { } }",
                    },
                    GeneratedSources =
                    {
                        (typeof(NullableSourceGenerator), "MemberNotNullAttribute.g.cs", @"// <auto-generated/>
